  ...
  <section id="hero">
    ...
    <div class="container">
      ...
      <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
        <h1>EDU.RIM</h1>
        <h2>est une plateforme éducative sénégalaise dont l’objectif est de rendre accessible le programme scolaire à tous les élèves, où qu’ils se situent sur le territoire nationale</h2>
